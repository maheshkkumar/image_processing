...
class Face_Detection():
	...
	def detect_local_image(self):
		complete_url = '/home/mahesh/visual_lifelog/image_processing/static/images/'+self.urlImage 
		...
		for i in range(len(result)):
			face.append(result[i]['faceAttributes'])	
		return face
